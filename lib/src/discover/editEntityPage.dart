...
class _EditEntityProfile extends State<EditEntityPage> {
  ...
  Future<void> updateBusinessAccount(BuildContext context, String about,
      Map<String, dynamic> userData, Function() loader) async {
    toggleLoader();
    ...
    realtimeDatabase.update({'about': about});
  ...
  Widget buildGridView(ScrollController scroller, bool imagesLoading) =>
      GridView.count(
        shrinkWrap: true,
        controller: scroller,
        crossAxisCount: 3,
