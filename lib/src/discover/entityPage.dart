...
class EntityPage extends StatefulWidget {
  const EntityPage({Key? key, required this.entity}) : super(key: key);
...
class _EntityPage extends State<EntityPage> {
  ...
  Future<void> loadCarouselPics() async {
    final businessPictures = await firebase_storage.FirebaseStorage.instance
        .ref()
        .child('business_pictures/${widget.entity.userId}')
        .listAll();
  ...
  Widget build(BuildContext context) {
    return loading == true
        ...
        : Scaffold(
            ...
            appBar: !widget.entity.isBusiness
                ? AppBar(
